// saxpy_mesh -- GENERATED by scripts/py/gen_mesh.py. Do not edit by hand.
//
//   xxx sax xxx
//   mag nul nul
//   xxx sax xxx
//
// 1x1 routers, 1 MAG port(s), 0 cluster(s), 0 vector core(s).
...
module saxpy_mesh #(
    ...
    saxpy_cu #(.FLIT_WIDTH(FW), .POS_WIDTH(PW), .POS_X(1), .POS_Y(0),
              .MEM_X(0), .MEM_Y(1), .INST_DEPTH(INST_DEPTH)) u_sax0 (
    ...
    saxpy_cu #(.FLIT_WIDTH(FW), .POS_WIDTH(PW), .POS_X(1), .POS_Y(2),
              .MEM_X(0), .MEM_Y(1), .INST_DEPTH(INST_DEPTH)) u_sax1 (
        .clk(clk), .resetn(resetn),
    ...
    assign l004_L1_1_fd = {FW{1'b0}}; assign l004_L1_1_fv = 1'b0; assign l004_L1_1_rb = 1'b0;
