// ktpu_ship_3x2_6c3v_il_pump -- GENERATED by scripts/py/gen_mesh.py. Do not edit by hand.
//
//   xxx xxx xxx xxx
//   mag mat mat vec
//   mag mat mat vec
...
module ktpu_ship_3x2_6c3v_il_pump #(
    ...
    generate if (MAG_CDC) begin : g_magcdc
        ...
        noc_local_cdc #(.FLIT_WIDTH(FW), .DEPTH(CDC_DEPTH)) u_mo2 (
            .wr_clk(axi_aclk), .wr_resetn(resetn),
            .i_data(mag_o_d[2*FW +: FW]), .i_valid(mag_o_v[2]),
            .i_busy(mag_o_b[2]),
            .rd_clk(clk), .rd_resetn(resetn),
            .o_data(l016_h0_3_fd), .o_valid(l016_h0_3_fv), .o_busy(l016_h0_3_fb)
        );
        noc_local_cdc #(.FLIT_WIDTH(FW), .DEPTH(CDC_DEPTH)) u_mi2 (
            .wr_clk(clk), .wr_resetn(resetn),
            .i_data(l016_h0_3_rd), .i_valid(l016_h0_3_rv), .i_busy(l016_h0_3_rb),
            .rd_clk(axi_aclk), .rd_resetn(resetn),
            .o_data(mag_i_d[2*FW +: FW]), .o_valid(mag_i_v[2]),
            .o_busy(mag_i_b[2])
        );
        ...
        assign mag_i_d[2*FW +: FW] = l016_h0_3_rd;
