// ktpu_ship_2x2_8c2v_1m_pump -- GENERATED by scripts/py/gen_mesh.py. Do not edit by hand.
//
//   xxx mat mat xxx
//   mag mat mat vec
//   mag mat mat vec
//   xxx mat mat xxx
//
// 2x2 routers, 2 MAG port(s), 8 cluster(s), 2 vector core(s).
...
module ktpu_ship_2x2_8c2v_1m_pump #(
    ...
    wire [FW-1:0] cu6_l2_id, cu6_l2_od;
    wire cu6_l2_iv, cu6_l2_ib, cu6_l2_ov, cu6_l2_ob;
    wire [FW-1:0] cu7_l2_id, cu7_l2_od;
    wire cu7_l2_iv, cu7_l2_ib, cu7_l2_ov, cu7_l2_ob;
    ...
    generate if (MAG_CDC) begin : g_magcdc
        ...
        noc_local_cdc #(.FLIT_WIDTH(FW), .DEPTH(CDC_DEPTH)) u_mo1 (
            ...
            .i_busy(mag_o_b[1]),
            .rd_clk(clk), .rd_resetn(resetn),
            .o_data(l009_h0_2_fd), .o_valid(l009_h0_2_fv), .o_busy(l009_h0_2_fb)
        );
        ...
        assign mag_i_d[1*FW +: FW] = l009_h0_2_rd;
    ...
    mx_cluster_cu #(.FLIT_WIDTH(FW), .POS_WIDTH(PW),
                    ...
                    .INST_DEPTH(INST_DEPTH), .RECV_DEPTH(RECV_DEPTH),
                    .UNIT_CDC(UNIT_CDC), .CDC_DEPTH(CDC_DEPTH), .PUMP(1),
                    .MEM_X(0), .MEM_Y(1), .MODEL(MODEL)) u_cu3 (
        .clk(clk), .clk2x(mat_clk2x), .unit_clk(mat_clk), .resetn(resetn),
    ...
    noc_l2_adapter #(.FLIT_WIDTH(FW), .POS_WIDTH(PW), .DEPTH(L2_CU_DEPTH),
                     .L2_BASE(L2_CU_BASE), .L2_BITS(L2_CU_BITS), .PASS(0)) u_cu6_l2 (
        .clk(clk), .rst(!resetn),
        ...
        .ep_data(cu6_l2_id), .ep_valid(cu6_l2_iv), .ep_busy(cu6_l2_ib),
        .eu_data(cu6_l2_od), .eu_valid(cu6_l2_ov), .eu_busy(cu6_l2_ob)
    );
    mx_cluster_cu #(.FLIT_WIDTH(FW), .POS_WIDTH(PW),
                    ...
                    .INST_DEPTH(INST_DEPTH), .RECV_DEPTH(RECV_DEPTH),
                    .UNIT_CDC(UNIT_CDC), .CDC_DEPTH(CDC_DEPTH), .PUMP(1),
                    .MEM_X(0), .MEM_Y(2), .MODEL(MODEL)) u_cu6 (
        .clk(clk), .clk2x(mat_clk2x), .unit_clk(mat_clk), .resetn(resetn),
        .noc_out_data(cu6_l2_od), .noc_out_valid(cu6_l2_ov), .noc_out_busy(cu6_l2_ob), .noc_in_data(cu6_l2_id), .noc_in_valid(cu6_l2_iv), .noc_in_busy(cu6_l2_ib),
        .fills_done(cu_f[6]), .gemms_done(cu_g[6]), .drains_done(cu_d[6])
    );
    noc_l2_adapter #(.FLIT_WIDTH(FW), .POS_WIDTH(PW), .DEPTH(L2_CU_DEPTH),
                     .L2_BASE(L2_CU_BASE), .L2_BITS(L2_CU_BITS), .PASS(0)) u_cu7_l2 (
        .clk(clk), .rst(!resetn),
        ...
        .ep_data(cu7_l2_id), .ep_valid(cu7_l2_iv), .ep_busy(cu7_l2_ib),
        .eu_data(cu7_l2_od), .eu_valid(cu7_l2_ov), .eu_busy(cu7_l2_ob)
    );
    mx_cluster_cu #(.FLIT_WIDTH(FW), .POS_WIDTH(PW),
                    ...
                    .INST_DEPTH(INST_DEPTH), .RECV_DEPTH(RECV_DEPTH),
                    .UNIT_CDC(UNIT_CDC), .CDC_DEPTH(CDC_DEPTH), .PUMP(1),
                    .MEM_X(0), .MEM_Y(2), .MODEL(MODEL)) u_cu7 (
        .clk(clk), .clk2x(mat_clk2x), .unit_clk(mat_clk), .resetn(resetn),
        .noc_out_data(cu7_l2_od), .noc_out_valid(cu7_l2_ov), .noc_out_busy(cu7_l2_ob), .noc_in_data(cu7_l2_id), .noc_in_valid(cu7_l2_iv), .noc_in_busy(cu7_l2_ib),
    ...
    noc_l2_adapter #(.FLIT_WIDTH(FW), .POS_WIDTH(PW), .DEPTH(L2_VEC_DEPTH),
        ...
        .clk(clk), .rst(!resetn),
        .rt_data(l005_h2_1_fd), .rt_valid(l005_h2_1_fv), .rt_busy(l005_h2_1_fb),
        .ru_data(l005_h2_1_rd), .ru_valid(l005_h2_1_rv), .ru_busy(l005_h2_1_rb),
    ...
    noc_l2_adapter #(.FLIT_WIDTH(FW), .POS_WIDTH(PW), .DEPTH(L2_VEC_DEPTH),
        ...
        .clk(clk), .rst(!resetn),
        .rt_data(l013_h2_2_fd), .rt_valid(l013_h2_2_fv), .rt_busy(l013_h2_2_fb),
        .ru_data(l013_h2_2_rd), .ru_valid(l013_h2_2_rv), .ru_busy(l013_h2_2_rb),
