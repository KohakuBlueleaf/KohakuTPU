// ktpu_ctrlpe_1x1 -- GENERATED by scripts/py/gen_mesh.py. Do not edit by hand.
//
//   xxx cpu xxx
//   mag mat vec
//   xxx nul xxx
...
module ktpu_ctrlpe_1x1 #(
    ...
    generate if (MAG_CDC) begin : g_magcdc
        ...
        noc_local_cdc #(.FLIT_WIDTH(FW), .DEPTH(CDC_DEPTH)) u_peo (
            ...
            .rd_clk(clk), .rd_resetn(resetn),
            .o_data(l002_v1_0_fd), .o_valid(l002_v1_0_fv), .o_busy(l002_v1_0_fb)
        );
        noc_local_cdc #(.FLIT_WIDTH(FW), .DEPTH(CDC_DEPTH)) u_pei (
            .wr_clk(clk), .wr_resetn(resetn),
            .i_data(l002_v1_0_rd), .i_valid(l002_v1_0_rv), .i_busy(l002_v1_0_rb),
            .rd_clk(axi_aclk), .rd_resetn(rstn_mag),
        ...
        assign l002_v1_0_fd = pe_o_d;
        assign l002_v1_0_fv = pe_o_v;
        assign pe_o_b = l002_v1_0_fb;
        assign pe_i_d = l002_v1_0_rd;
        assign pe_i_v = l002_v1_0_rv;
        assign l002_v1_0_rb = pe_i_b;
    end endgenerate
    ...
    vec_cu #(.FLIT_WIDTH(FW), .POS_WIDTH(PW), .POS_X(2), .POS_Y(1),
             .MEM_X(0), .MEM_Y(1), .MODEL(MODEL),
             .INST_DEPTH(INST_DEPTH), .RECV_DEPTH(RECV_DEPTH),
             .UNIT_CDC(UNIT_CDC), .CDC_DEPTH(CDC_DEPTH),
             .L1_DEPTH(L1_DEPTH), .L1_PRIM(VEC_PRIM)) u_vec0 (
        .clk(clk), .unit_clk(vec_clk), .resetn(rstn_vec),
        .noc_out_data(l001_h1_1_rd), .noc_out_valid(l001_h1_1_rv), .noc_out_busy(l001_h1_1_rb), .noc_in_data(l001_h1_1_fd), .noc_in_valid(l001_h1_1_fv), .noc_in_busy(l001_h1_1_fb),
