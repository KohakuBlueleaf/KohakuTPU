// ktpu_ship_1x2_4c0v_1m_pump -- GENERATED by scripts/py/gen_mesh.py. Do not edit by hand.
//
//   xxx xxx xxx
//   mag mat mat
//   mag mat mat
//   xxx xxx xxx
//
// 1x2 routers, 2 MAG port(s), 4 cluster(s), 0 vector core(s).
// GRID_X_HI=1 GRID_Y_HI=2: the clamp is per axis, so the grid need not
...
module ktpu_ship_1x2_4c0v_1m_pump #(
    ...
    wire [FW-1:0] l005_h0_2_fd; wire l005_h0_2_fv; wire l005_h0_2_fb;
    wire [FW-1:0] l005_h0_2_rd; wire l005_h0_2_rv; wire l005_h0_2_rb;
    wire [FW-1:0] l006_h1_2_fd; wire l006_h1_2_fv; wire l006_h1_2_fb;
    wire [FW-1:0] l006_h1_2_rd; wire l006_h1_2_rv; wire l006_h1_2_rb;
    wire [FW-1:0] l007_v1_2_fd; wire l007_v1_2_fv; wire l007_v1_2_fb;
    wire [FW-1:0] l007_v1_2_rd; wire l007_v1_2_rv; wire l007_v1_2_rb;
    wire [FW-1:0] l008_L1_2_fd; wire l008_L1_2_fv; wire l008_L1_2_fb;
    wire [FW-1:0] l008_L1_2_rd; wire l008_L1_2_rv; wire l008_L1_2_rb;
    ...
    NoCRouter #(.DATA_WIDTH(FW), .FIFO_DEPTH(512),
                ...
                .GRID_Y_HI(2)) r1_2 (
        .clk(clk), .rst(rst),
        .west_in_data(l005_h0_2_fd),   .west_in_valid(l005_h0_2_fv),   .west_in_busy(l005_h0_2_fb),
        .west_out_data(l005_h0_2_rd),  .west_out_valid(l005_h0_2_rv),  .west_out_busy(l005_h0_2_rb),
        .east_in_data(l006_h1_2_rd),   .east_in_valid(l006_h1_2_rv),   .east_in_busy(l006_h1_2_rb),
        .east_out_data(l006_h1_2_fd),  .east_out_valid(l006_h1_2_fv),  .east_out_busy(l006_h1_2_fb),
        ...
        .south_in_data(l007_v1_2_rd),  .south_in_valid(l007_v1_2_rv),  .south_in_busy(l007_v1_2_rb),
        .south_out_data(l007_v1_2_fd), .south_out_valid(l007_v1_2_fv), .south_out_busy(l007_v1_2_fb),
        .local_in_data(l008_L1_2_fd),  .local_in_valid(l008_L1_2_fv),  .local_in_busy(l008_L1_2_fb),
        .local_out_data(l008_L1_2_rd), .local_out_valid(l008_L1_2_rv), .local_out_busy(l008_L1_2_rb)
    );
    generate if (MAG_CDC) begin : g_magcdc
        ...
        noc_local_cdc #(.FLIT_WIDTH(FW), .DEPTH(CDC_DEPTH)) u_mo1 (
            ...
            .i_busy(mag_o_b[1]),
            .rd_clk(clk), .rd_resetn(resetn),
            .o_data(l005_h0_2_fd), .o_valid(l005_h0_2_fv), .o_busy(l005_h0_2_fb)
        );
        noc_local_cdc #(.FLIT_WIDTH(FW), .DEPTH(CDC_DEPTH)) u_mi1 (
            .wr_clk(clk), .wr_resetn(resetn),
            .i_data(l005_h0_2_rd), .i_valid(l005_h0_2_rv), .i_busy(l005_h0_2_rb),
            .rd_clk(axi_aclk), .rd_resetn(resetn),
        ...
        assign l005_h0_2_fd = mag_o_d[1*FW +: FW];
        assign l005_h0_2_fv = mag_o_v[1];
        assign mag_o_b[1] = l005_h0_2_fb;
        assign mag_i_d[1*FW +: FW] = l005_h0_2_rd;
        assign mag_i_v[1] = l005_h0_2_rv;
        assign l005_h0_2_rb = mag_i_b[1];
    end endgenerate
    ...
    noc_l2_adapter #(.FLIT_WIDTH(FW), .POS_WIDTH(PW), .DEPTH(L2_CU_DEPTH),
        ...
        .clk(clk), .rst(!resetn),
        .rt_data(l001_h1_1_fd), .rt_valid(l001_h1_1_fv), .rt_busy(l001_h1_1_fb),
        .ru_data(l001_h1_1_rd), .ru_valid(l001_h1_1_rv), .ru_busy(l001_h1_1_rb),
    ...
    noc_l2_adapter #(.FLIT_WIDTH(FW), .POS_WIDTH(PW), .DEPTH(L2_CU_DEPTH),
        ...
        .clk(clk), .rst(!resetn),
        .rt_data(l008_L1_2_rd), .rt_valid(l008_L1_2_rv), .rt_busy(l008_L1_2_rb),
        .ru_data(l008_L1_2_fd), .ru_valid(l008_L1_2_fv), .ru_busy(l008_L1_2_fb),
    ...
    noc_l2_adapter #(.FLIT_WIDTH(FW), .POS_WIDTH(PW), .DEPTH(L2_CU_DEPTH),
        ...
        .clk(clk), .rst(!resetn),
        .rt_data(l006_h1_2_fd), .rt_valid(l006_h1_2_fv), .rt_busy(l006_h1_2_fb),
        .ru_data(l006_h1_2_rd), .ru_valid(l006_h1_2_rv), .ru_busy(l006_h1_2_rb),
    ...
    assign l007_v1_2_rd = {FW{1'b0}}; assign l007_v1_2_rv = 1'b0; assign l007_v1_2_fb = 1'b0;
