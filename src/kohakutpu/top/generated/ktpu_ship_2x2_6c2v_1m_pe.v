// ktpu_ship_2x2_6c2v_1m_pe -- GENERATED by scripts/py/gen_mesh.py. Do not edit by hand.
//
//   xxx mat vec xxx
//   mag mat mat cpu
//   mag mat mat xxx
...
module ktpu_ship_2x2_6c2v_1m_pe #(
    ...
    generate if (MAG_CDC) begin : g_magcdc
        ...
        noc_local_cdc #(.FLIT_WIDTH(FW), .DEPTH(CDC_DEPTH)) u_peo (
            .wr_clk(axi_aclk), .wr_resetn(rstn_mag),
        ...
        assign l005_h2_1_rd = pe_o_d;
        assign l005_h2_1_rv = pe_o_v;
        assign pe_o_b = l005_h2_1_rb;
        assign pe_i_d = l005_h2_1_fd;
        assign pe_i_v = l005_h2_1_fv;
        assign l005_h2_1_fb = pe_i_b;
    end endgenerate
    ...
    mx_cluster_cu #(.FLIT_WIDTH(FW), .POS_WIDTH(PW),
        ...
        .clk(clk), .clk2x(1'b0), .unit_clk(mat_clk), .resetn(rstn_mat),
