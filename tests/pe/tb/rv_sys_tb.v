...
`ifdef RV_TRACE_LINE
    ...
    always @(posedge clk) if (rstn) begin
        if (tr_wbv && tr_wbr && (tr_wb[30:5] == `RV_TRACE_LINE)) begin
        ...
        if (
            ...
            && dut.g_pe[0].g_have.u_pe.u_req.send_ready
            && ($time > `RV_TRACE_FROM)
        ) begin
        ...
        if (
            dut.u_ram.s_axi_wvalid
            && dut.u_ram.s_axi_wready
