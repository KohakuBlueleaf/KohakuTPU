...
const assembly = {
  nodes: [
    ...
    },
    {
      ...
      h: 3.6,
      label: "u_req",
      sub: "the NoC requestor · WR_MAX = 1",
    },
    {
      id: "l1",
      x: 0,
      ...
      h: 3.6,
      label: "u_l1",
      sub: "128 lines over DRAM · 1 BRAM",
    },
    {
      id: "glue",
      x: 16,
      ...
      sub: "183 LUT · CU_DATA in, CU_SIGNAL out",
    },
    {
      id: "imem",
      x: 16,
    ...
    },
    {
      ...
      h: 3.6,
      label: "u_core",
      sub: "the RV32I pipeline · 1,187 LUT",
      accent: true,
    },
  ],
  edges: [
...
const pipe = {
  nodes: [
    ...
    },
    {
      ...
      h: 4,
      label: "EX",
      sub: "ALU, branch resolve, address",
      accent: true,
    },
    {
      id: "mem",
      ...
      h: 4,
      label: "MEM",
      sub: "array address, write enables",
    },
    {
      id: "wb",
      x: 52.5,
    ...
    },
    {
      ...
      w: 9,
      h: 3.6,
      label: "window addr reg",
      sub: "synchronous array",
    },
    {
      id: "ra",
      x: 10.5,
  ...
  rows: [
    {
      src: "EX",
      d: "1",
      what: "forward the ALU output, or stall — see <code>FWD_X</code>",
    },
    {
      src: "MEM",
      d: "2",
      what: "forward the EX result register; <b>stall if it is a load</b>",
    },
...
const d4rows = (sees) => [
  ...
  { name: "MEM", kind: "bus", values: [null, null, null, "i0", "i1", "i2"] },
  {
    name: "WB",
    kind: "bus",
    values: [null, null, null, null, "i0", "i1"],
    mark: [4],
  },
  {
    name: "x5 write enable",
    kind: "bit",
    values: [0, 0, 0, 0, 1, 0],
    mark: [4],
  },
  {
    name: "i4 rs1 addr captured",
    kind: "bit",
    values: [0, 0, 0, 0, 1, 0],
    mark: [4],
  },
...
const predTaken = [
  {
    name: "fetch addr",
    kind: "bus",
    values: ["0x40", "0x44", "0x48", "0x20", "0x24"],
    mark: [3],
  },
  {
    name: "BTB, same addr",
...
const mispredict = [
  {
    name: "fetch addr",
    kind: "bus",
    values: ["0x48", "0x4C", "0x50", "0x54", "0x20"],
    mark: [4],
  },
  {
    name: "the branch is in",
    kind: "text",
    values: ["IF2", "ID", "EX — resolves", "", ""],
  },
  {
...
const units = {
  ...
  rows: [
    ...
    {
      u: "top glue: window writer, kick FSM",
      lut: "183",
      logic: "183",
      lram: "0",
      ff: "413",
    ...
    {
      u: "<code>u_base</code> — the framework attach",
      lut: "657",
      logic: "409",
      lram: "248",
      ff: "1,381",
    ...
    {
      u: "<code>u_core</code> — the RV32I pipeline",
      lut: "1,187",
      logic: "1,115",
      lram: "72",
      ff: "1,013",
    ...
    {
      u: "<code>u_req</code> — NoC requestor",
      lut: "147",
      logic: "147",
      lram: "0",
      ff: "883",
...
const coreSplit = {
  items: [
    {
      label: "EX — one adder, one subtractor, one shifter. No multiplier",
      value: 418,
    },
    { label: "ID — operands, forwarding, branch target", value: 234 },
    { label: "MEM", value: 181 },
    {
      label: "IF, with the whole predictor",
      value: 135,
      note: "entries live in LUTRAM depth",
    },
  ...
  rows: [
    {
      ...
      fmax: "<b>410.8 MHz</b>",
      lut: "<b>2,491</b>",
      verdict: "<b>constrain it here</b> — 0.899 ns to spare",
      _tone: "good",
    },
    {
      ask: "2.5 ns",
      fmax: "410.8 MHz",
      lut: "2,583",
      verdict: "~90 extra sites for zero megahertz",
      _tone: "warn",
    },
    {
      ask: "2.2 – 2.0 ns",
      fmax: "410.8 MHz",
      lut: "+350 – 400",
      verdict: "13–15 % of the unit for zero megahertz",
      _tone: "bad",
    },
  ],
};
...
const itiming = {
  ...
  rows: [
    ...
    {
      ev: "<code>ECALL</code> / <code>EBREAK</code>",
      cost: "halts; the completion carries the word",
    },
...
const scaling = {
  ...
  rows: [
    {
      what: "cycles — identical instruction stream at every count",
      one: "7,418",
  ...
  rows: [
    {
      p: "BTB_ENTRIES",
      d: "32",
      w: "predictor size; 0 removes the predictor entirely (a generate)",
    },
    {
      p: "FWD_X",
      d: "1",
    ...
    },
    {
      p: "L1_LINES",
      d: "128",
      w: "internal L1 lines. 128 fills the BRAM's natural depth; halving saves almost nothing",
    },
    {
      p: "REGFILE_PRIM",
      d: '"distributed"',
      w: "LUTRAM vs block-RAM register file. Interchangeable timing; a resource trade",
    },
    {
      p: "IMEM_WORDS / SPAD_WORDS",
      d: "2048",
      w: "the two windows, sized to fill their BRAM tiles exactly",
    },
    {
      p: "WR_MAX",
      d: "1",
 ...
 * Source: docs/arch/pe/microarchitecture.md, docs/projects/kohakumpe/simd/performance.md. */
...
const absent = {
  ...
  rows: [
    ...
    },
    {
      ...
      w: "the float lanes of the wide classes built on this core, one fused multiply-add per element. Their format, their widths and their measurements are KohakuMPE's. What holds here regardless: <b>none of it is reachable from a scalar register</b>",
      _tone: "bad",
    },
    {
...
const mulCost = {
  ...
  rows: [
    {
      s: "<code>mul</code> alone, pipelined",
      d: "3",
      l: "~20 + registers",
      i: "1",
      t: "3–4",
    ...
    {
      s: "one DSP, multi-cycle over four passes",
      d: "1",
      l: "~150",
      i: "1 per 4–5 cycles",
      t: "4–5",
...
const gates = {
  ...
  rows: [
    ...
    {
      g: "--gate 4",
      w: "one, two and four PEs sharing a NoC and a memory agent — where the communication protocol is proven between running cores rather than against a bench",
    },
  ],
};
</script>
...
<template>
  ...
  >
    <p class="doc-p">
      ...
      compatibility so ordinary compilers work; <b>very low LUT</b>, so dozens
      of PEs on one device are realistic; <b>high Fmax</b>, so scalar control is
      never the slow component; and a memory frontend that is part of the core
      rather than a generic CPU bus with an adapter bolted on.
    </p>

    <Callout kind="rule" title="LUT and frequency outrank latency everywhere">
      <p>
        The core spends FF and BRAM freely, prefers a pipeline stage over a
        bypass, and registers anything whose combinational form would fan out.
        Every shape on this page follows from that, and where it does not, the
        exception is measured.
      </p>
    </Callout>
    ...
    <p class="doc-p">
      ...
      window in the address map. The layout is the architecture:
    ...
    <p class="doc-p">
      The extra boundary exists because the instruction window and the register
      file are synchronous arrays: each costs a cycle between presenting an
      address and receiving data, and counting those honestly is what lets the
      fetch loop close. The address path in fetch is
    ...
    <Callout kind="note" title="Two more shapes in the same budget">
      <p>
        A branch or jump target is computed <b>in ID rather than EX</b>: PC and
      ...
      <p>
        EX carries <b>one adder, one subtractor and one shifter</b>, not three
        of each. <code>SUB</code>, <code>SLT</code>/<code>SLTU</code> and every
        branch comparison come off the one subtractor; <code>SLL</code>,
        <code>SRL</code> and <code>SRA</code> share a single 33-bit arithmetic
        right shifter between two bit reversals — a left shift is a right shift
        on the reversed word, and reversals are wiring.
      </p>
      <p>
        <b
          >The adder is not shared with the subtractor, and that is
          structural.</b
        >
        <code>sum = op1 + op2</code> is also <code>ex_addr</code>, which leaves
        the stage combinationally to the data arrays' address pins — so anything
        muxed into its inputs lands in front of that path. It is the one adder
        in this core that cannot be borrowed, which is what decides the divider
        below.
      </p>
    </Callout>
    ...
    <p class="doc-p">
      A load's data does not exist until WB, which is why distances 1 and 2
      stall on a load and distance 3 does not. That is the load-use penalty: two
    ...
    <WaveTrace
      ...
      :notes="[
        {
          cycle: 2,
          text: 'The consumer is in ID at distance 1 from a load in EX, and a load\'s value does not exist yet. It is held in ID; fetch holds with it.',
        },
        {
          cycle: 4,
    ...
    <WaveTrace
      ...
      :notes="[
        {
          cycle: 4,
          text: 'i0 writes x5 in WB at the same edge that captures i4\'s register-file read address in IF2.',
          tone: 'bad',
        },
        {
          cycle: 5,
          text: 'The array returns the pre-write value. The forwarding network covers distances 1, 2 and 3 and does not see this one. The kind of bug that survives a casual test suite.',
          tone: 'bad',
        },
      ]"
    />
    ...
    <WaveTrace
      ...
      :notes="[
        {
          cycle: 5,
          text: 'The co-simulation covers every producer-to-consumer distance by construction, which is what turns this from a case someone remembered into a case that cannot be missed.',
          tone: 'good',
        },
      ]"
    />
    ...
    >
      <p>
        ...
        frequency; measured, it saves about <b>2 LUT and loses 5 MHz</b>,
        because without the bypass the stall term widens from
        <code>hz1 &amp;&amp; x_load</code> to <code>hz1</code> and that term
        fans out across the whole front end. The 0 form stays built and verified
        so the claim survives re-measurement.
      </p>
    </Callout>
    ...
    <p class="doc-p">
      A small BTB plus a 2-bit saturating table, read with the
      <b>same address as the instruction window</b>. Its job is to remove the
      taken-branch penalty of a loop, not to be accurate: nothing in it is
      speculative state needing repair, because EX resolves every branch against
      the architectural answer. A wrong prediction costs the redirect penalty
      and never correctness — which is why the tag can be short and the table
      can alias.
    </p>
    ...
    <WaveTrace
      ...
      :notes="[
        {
          cycle: 2,
          text: 'Tag, target, valid and counter all ride in one LUTRAM entry, so the entry count buys memory depth rather than logic. The prediction is available in the cycle the instruction\'s bits are.',
        },
      ]"
    />
    ...
    <WaveTrace
      :rows="mispredict"
      label="mispredict — three cycles"
      :notes="[
        {
          cycle: 3,
          text: 'A redirect is registered. Steering fetch in the resolve cycle would put the ALU output into the next-PC mux; one more cycle costs a third bubble and keeps the ALU output going nowhere but a flop.',
        },
        {
    ...
    <p class="doc-p">
      The I/D split is recast as <b>external L1 and internal L1</b>, split by
      <i>who writes</i>, not by what is stored. This is the single idea that
    ...
    <p class="doc-p">
      ...
      push lands in the very word a poll loop is reading —
      ...
      undefined data for that collision in silicon, and per-port reasoning
      (“neither port reads what it writes”) is true per port and false across
      them.
    </p>
    ...
    <WaveTrace
      ...
      :notes="[
        {
          cycle: 2,
          text: 'Undefined data, at the exact moment the protocol depends on. A poll that sampled the array mid-push reads garbage and goes round the loop once more — and a four-instruction poll loop is ~9 cycles, so one extra iteration costs a whole loop.',
          tone: 'bad',
        },
      ]"
    />
    ...
    <WaveTrace
      ...
      :notes="[
        {
          cycle: 2,
          text: 'When the NoC port writes the word the core is reading, the core receives the written bytes — correct rather than merely defined, and byte-wise because a peer\'s sb is as legal as a local one.',
          tone: 'good',
        },
        {
          cycle: 2,
          text: 'It costs 38 LUT and sits on the critical path, which is the price of the doorbell being right. The scratchpad is 45 LUT rather than the ~7 of a plain array for exactly this reason.',
        },
      ]"
    />
    ...
    <Callout
      kind="rule"
      title="The other array answers differently, and says so"
    >
      <p>
        The internal L1's fill collides too — a fill writes the word a stalled
        access is presenting — and answers the opposite way: the colliding read
        is <b>discarded and re-issued</b> after the fill. Which answer is right
        belongs to the caller, not the array. The RAM wrapper
        (<code>rv_ram_be</code>) makes the choice explicit:
        <b
          >an array that does not declare how it handles the collision asserts
          the moment one happens.</b
        >
      </p>
    </Callout>
    ...
    <p class="doc-p">
      Two jobs, and the second does not depend on hit rate:
      <b>protocol adaptation</b>. A 32-byte line is exactly one NoC/MAG payload,
      so a fill is one request and one response and a writeback is one
      descriptor and one beat. Ordinary <code>lb</code>/<code>lh</code>/<code
        >lw</code
      >
      and <code>sb</code>/<code>sh</code>/<code>sw</code> are presented to
      software while the upstream protocol stays line-oriented.
    </p>

    <p class="doc-p">
      It is direct mapped and blocking, with <b>one outstanding miss</b>. No
      MSHRs, no hit-under-miss, no load/store queue: latency tolerance in this
      machine comes from having many independent PEs, and whether per-core miss
    ...
    <Callout
      kind="note"
      title="Why the arrays are 32 bits, and what the rotate costs"
    >
      <p>
        A flit carries 256 bits, so a 256-bit array port looks natural. It is
        not: a
        <code>RAMB36E2</code> in true-dual-port mode is 36 bits per port, so a
        256-bit TDP array is eight BRAMs whose 32-bit face is the only one the
        CPU uses — and every read needs an 8:1 32-bit mux on the load path.
        Walking a line as eight 32-bit words costs 8 cycles per fill against a
        DRAM latency of hundreds, and zero LUT.
      </p>
      <p>
        The 256-bit line buffer between array and fabric is a <b>rotate</b>, not
        an indexed register. <b>The limit of the trick is worth stating:</b> a
        rotate needs a 2:1 mux on every bit, so it pays only where the register
        was already written word-at-a-time and that mux already existed —
        applied to a register loaded whole, the same construction <i>adds</i>
        logic.
      </p>
      <p>
        Per-line <code>valid</code> and <code>dirty</code> ride in the tag
        LUTRAM beside the tag rather than in flop arrays — indexed flop arrays
        cost LUT twice, once as flops and once as the read mux in front of the
        tag compare. The consequence is that invalidate-all is a
        one-line-per-cycle sweep rather than a broadcast, which is why
        <code>CTL_INVAL</code>
        blocks.
      </p>
    </Callout>
    ...
    <Callout kind="rule" title="Primitives are named, never inferred">
      <p>
        Left to inference, both the resource and the read latency can move
        between tool versions, and read latency here is pipeline structure.
      </p>
    </Callout>
    ...
    <p class="doc-p">
      Everything about the framework memory protocol that RV32 software must
      never see: transaction tags, descriptor legality, response matching, write
    ...
    <Callout
      kind="trap"
      title="The same trap, one level down, with a number on it"
    >
      <p>
        The SIMD PE's vector window write is the same shape: letting the NoC's
        write enable — combinational from the receive FIFO's empty flag — reach
        the MEM stage's stall, the fetch hold and the instruction window's
        address was measured at
        <b>93.6 MHz of the assembled PE's clock</b>. The framework's own
        requestor registers its push handshake for exactly this reason —
        <RouterLink to="/mpe/simd" class="doc-link">SIMD PE</RouterLink>.
      </p>
    </Callout>
    ...
    <p class="doc-p">
      One decoder, deciding on the
      <b>top four address bits and nothing else</b>.
      <code>0x8xxx_xxxx</code> upward is a 2 GB software window onto physical
      DRAM; the translation is <code>DRAM_BASE | addr[30:0]</code> — OR-ed,
      never added, because the base's low 31 bits are zero by construction, so
      it costs no logic.
    </p>
    ...
    <Callout kind="rule" title="Reads of a peer window do not exist">
      <p>
        ...
        <i>own</i> scratchpad with an ordinary load: one cycle, zero NoC
        traffic. For bulk data, go through DRAM or the mover rather than pushing
        word by word; a peer push is one word per store.
      </p>
    </Callout>
    ...
    <Callout kind="note" title="What is deliberately absent">
      <p>
        ...
        writable memory is the home of its own addresses (never a copy), and the
        only cached memory is never externally written. No atomics: exclusive
        access between cores is done by ownership and push, not by locks.
        <code>FENCE</code> executes as a NOP — one core, one memory port,
        already ordered — and <code>FENCE.I</code> is not needed, because the
        instruction window is not writable from the data side.
      </p>
    </Callout>
    ...
    <p class="doc-p">
      ...
      older already has. Misaligned load and store <b>fault</b>, which RV32I
      permits.
    </p>
    ...
    <SpecTable
      :cols="halts.cols"
      :rows="halts.rows"
      caption="The cause and word are readable at CTL_CAUSE after the halt, and travel in the completion signal"
    />
    ...
    <Callout
      kind="trap"
      title="Two numbers for the same core, and both are right"
    >
      <p>
        This PE is <b>2,491 LUT at 410.8 MHz</b> in a flattened run and
        <b>2,477 LUT at 377.9 MHz</b> in a hierarchy-preserved one — both at the
        same 3.333 ns ask, both the same RTL. The second is the flow the SIMD PE
        is measured in, so it is the one to hold beside a DSP figure; 33 MHz of
        that spread is the flow, not the design.
    ...
    <Callout
      kind="measured"
      title="Two of those rows are design outcomes, not accounting"
    >
      <p>
        The <b>scratchpad is 45 LUT</b> rather than the ~7 of a plain array
        because 38 of them are the cross-port bypass that makes the doorbell
        correct — a priced correctness cost, sitting on the critical path.
      </p>
      <p>
        And <b>a quarter of the unit is the framework attach</b>:
        <code>u_base</code> is 657 LUT and 1,381 FF of port logic that every
        compute unit on this fabric carries, processor or not — the marginal
        cost of <i>this unit being a processor</i> is nearer <b>1,900 LUT</b>.
      </p>
    </Callout>
    ...
    <p class="doc-p">
      The ceiling is a block RAM's clock-to-out, and the design reaches it at a
      3.333 ns request. Below that the constraint buys nothing: synthesis
      answers an impossible request by spending LUT on a path whose length it
      cannot change.
    </p>
    ...
    <SpecTable
      :cols="freq.cols"
      :rows="freq.rows"
      caption="xcvu13p-fhgb2104-2L-e, Vivado 2024.2, OOC synthesis only. At the mesh ship clock — noc_clk at 300 MHz — the PE carries better than 30 % timing margin"
    />

    <Callout kind="measured" title="The critical path is the load-data return">
      <p class="font-mono kt-text-caption">
        u_spad/.../mem_reg_0/CLKBWRCLK → u_core/u_id/x_op1_reg[16]/D
        &nbsp;·&nbsp; 6 levels
      </p>
      <p>
        A data array's clock-to-out, the cross-port bypass, the sub-word
        extract, the forwarding network, the ID operand register. It is the
        <b>distance-3 forward of a load result</b> — the one hazard distance
        resolved by forwarding because a load's data exists no earlier — and the
        array at its head is the scratchpad, whose cross-port bypass put a mux
        between the array and the extract. A scalar core with honest synchronous
        memories ends at the speed a memory hands a word back, and this one
        does.
      </p>
    </Callout>
    ...
    <Callout
      kind="note"
      title="The register file is LUTRAM, and that is the same argument"
    >
      <p>
        A block-RAM form exists behind <code>REGFILE_PRIM</code> with identical
        timing, but a 32 × 32 register file leaves a 1K × 36
        <code>RAMB36E2</code> <b>3.1 % depth-utilized</b> — the worst ratio
        anything in this design could post — so the LUTRAM form ships.
      </p>
    </Callout>
    ...
    <SpecTable
      :cols="itiming.cols"
      :rows="itiming.rows"
      caption="Read from the PE's own CTL_CYCLE / CTL_INSTRET counters on the full system: real routers, the real memory agent, RAM behind it"
    />
    ...
    <p class="doc-p">
      ...
      quantised by the poll: a four-instruction poll loop is ~9 cycles, and a
      push is observable only when the loop next comes round, so one extra
      iteration costs a whole loop. That quantisation is what the scratchpad's
      cross-port bypass buys.
    </p>
    ...
    <Callout
      kind="rule"
      title="One definition reaches both the bench and synthesis"
    >
      <p>
        Configuration knobs flow to the benches and to synthesis from the same
        definition, so what levels 1–4 verified is what the synthesis measured —
        a knob that reached only one of the two would silently decouple them.
      </p>
    </Callout>
    ...
    <p class="doc-p">
      <b
        >There is no multiplier, no divider and no floating point in this
        core.</b
      >
      <code>mul</code> faults: the decoder accepts <code>funct7</code> of
      <code>0000000</code> and <code>0100000</code> on the register-register
      group and nothing else, so RV32M's <code>0000001</code> raises an
      illegal-instruction halt at the offending PC.
    </p>
    ...
    <Callout
      kind="trap"
      title="No SCALAR datapath in this machine has a multiplier — but the SIMT PE does"
    >
      <p>
        It is easy to read “the machine has float” and conclude the wrong thing
        about this core, and just as easy to read “this core has no multiply”
        and conclude the wrong thing about the machine. The SIMD PE's multiply
        and its float tier live in the <i>vector</i> register file behind
        custom-0 and custom-1, and reaching them means putting operands in
        <code>v0..v7</code>. The SIMT PE's <i>uniform</i> ALU is
        <b>ten</b> register-register operations — the same ten RV32I has.
      </p>
      <p>
        <b
          >The SIMT PE's per-thread datapath, however, has
          <code>RV32M</code>.</b
        >
        <code>mul</code>, <code>mulh</code>, <code>mulhsu</code> and
        <code>mulhu</code> run on the per-thread register file, one product per
        lane, on the standard <code>OP</code> encoding — so a shader that writes
        <code>a * b</code> gets one instruction.
        <b
          >On this core and on the SIMD PE's scalar half it still calls
          libgcc.</b
        >
        The DSP page prices that: the base core's 128-element int8 dot is 8,221
        cycles and the same kernel with its multiply costed at one instruction
        is 1,297, so 128 software multiplies account for 6,924 cycles —
        <b>about 54 cycles each</b>, and that is the easy case, because int8
        operands unroll to eight shift-add steps where a general 32×32 unrolls
        to far more.
      </p>
      <p>
        <code>div</code> and <code>rem</code> fault on every class, per-thread
        included.
      </p>
    </Callout>
    ...
    <Callout
      kind="measured"
      title="Take the pipelined multiplier, not the multi-cycle one"
    >
      <p>
        The multi-cycle form saves three DSP columns, and on this device
        <b>a DSP column is worth about 230 LUT</b> — so it trades ~690 LUT of
        nominal value for real sequencing logic on a resource the design is
        explicitly <i>not</i> short of. LUT is the binding resource here and DSP
        is not.
      </p>
    </Callout>
    ...
    <Callout
      kind="trap"
      title="The cost is not the multiplier — it is where its result joins"
    >
      <p>
        <b>The result mux is on the distance-1 forwarding path.</b>
        <code>ex_alu</code> feeds both <code>m_val</code> and
        <code>fwd_x_val</code>, and <code>fwd_x_val</code> is an input to
        <code>x_op1_reg</code> — the register the critical path above already
        ends at. Adding a case to that mux is one more LUT level in exactly the
        wrong place. The SIMD PE measures this shape one level up: its binding
        path ends at a result mux feeding a write port, and removing one block
        from that mux buys <b>33.9 MHz</b>.
      </p>
      <p>
        <b>And the stall term widens.</b> A 3-cycle multiply in an in-order core
        with three positional forwarding sources must stall EX — a new term in
        <code>stall_d</code>. The <code>FWD_X</code> result above is the
        warning: widening a stall term that was already there cost
        <b>5 MHz</b> and saved 2 LUT.
      </p>
      <p>
        The alternative is a scoreboard, letting the multiply retire out of
        order. <b>Do not.</b>
        The hazard unit is the whole of this core's complexity budget — three
        sources by position, one stall rule, nothing else — and a scoreboard
        ends that invariant for one instruction.
        <b>ESTIMATE −5 to −15 MHz</b> on a 410.8 MHz core, and the mux is what
        to measure first.
      </p>
    </Callout>
    ...
    <p class="doc-p">
      The costing above is still the costing for <b>this</b> core. What has
      happened since is that the machine got its multiplier somewhere else — and
      the reason is exactly the two risks just named, because the SIMT PE has
      neither of them.
    </p>
    ...
    <Callout
      kind="rule"
      title="The general rule, now with a built example behind it"
    >
      <p>
        <b
        ...
        >
        That is what this core's costing was pointing at all along; the SIMT PE
        is what it looks like when the machinery is already there.
      </p>
      <p>
        Note the other half of why it was cheap: <code>RV32M</code> is
        <b>standard encoding space</b>, so it cost none of the four custom
    ...
    <Callout
      kind="rule"
      title="Iterative division is a trap at this size, and the mechanism is specific"
    >
      <p>
        An iterative divider is ~35 cycles and a
        <b>33-bit subtract per cycle</b>, and it cannot borrow the one in EX:
        <code>sum</code> is <code>ex_addr</code>. Muxing a divider's operands
        into that adder puts a mux in front of the effective address — the one
        path the whole six-boundary arrangement exists to keep short, because
        the address leaves EX combinationally precisely so the data arrays can
        register it.
      </p>
      <p>
        So a divider carries its own subtractor, its own remainder shift
        register, its own quotient register, the sign fixups <code>div</code>'s
        truncate-toward-zero needs, and the two mandated special cases (÷0, and
        −2³¹ ÷ −1). <b>200–300 LUT ESTIMATE</b> — most of the EX stage's own 418
        again — for a <b>2×</b> against libgcc on an instruction a controller
        issues approximately never, where <code>mul</code> is an <b>8–13×</b> on
        a common one. If <code>mul</code> is built, divide-by-a-constant
        strength-reduces to <code>mulhu</code> and covers the case a controller
        actually meets.
      </p>
    </Callout>
    ...
    <Callout
      kind="rule"
      title="Minimal scalar float is the wrong purchase, and not because of the LUT"
    >
      <p>
        The tempting shape is to reuse what is already measured:
        <code>khs_f16_lane</code> is <b>609 LUT and 2 DSP</b>, fifteen cycles
        deep, II = 1, its FMA verified bit-for-bit against a golden model. One
        of those, a 32-entry float register file, and the two FP32 converters —
        one of which is pure wiring, because E8 <i>is</i> FP32's exponent field
        — is roughly <b>900–1,100 LUT and 2 DSP, ESTIMATE</b>.
      </p>
      <p>
        ...
        scoreboard just refused. The SIMD tier does not have this problem
        because an <i>accumulating</i> instruction needs only the accumulator's
        own busy shadow, where an instruction that writes a register has to be
        tracked.
      </p>
      <p>
        <b>And it would not be <code>F</code>, so no compiler would emit it.</b>
        E8M15 is 24 bits with no subnormals, one rounding mode, and a documented
        one-ulp deviation on subtractive alignment; RISC-V's <code>F</code> is
        IEEE-754 binary32 with subnormals, five rounding modes and
        <code>fcsr</code>, and this core has no CSR file at all. A
        non-conforming float behind a custom major also has nowhere to live —
        <b>all four custom majors are spoken for</b>. The core's first design
        objective is that ordinary compilers work unmodified.
      </p>
    </Callout>

    <Callout
      kind="open"
      title="The recommendation: build mul/mulh. Not div/rem. Not scalar float."
    >
      <p>
        <code>mul</code> is the only one of the three that is
        <b>standard encoding space</b>, that GCC emits with nothing more than
        <code>-march=rv32im</code>, and that removes a measured 54-cycle tax
        from every index computation — and from every benchmark baseline this
        project publishes, which today has to carry a twin whose multiply is
        costed by hand to stay honest. Four DSP columns on a device where DSP is
        not the binding resource is the cheapest thing this core could spend.
      </p>
      <p>
        The other two belong where the arithmetic already is.
        <b>Both wide classes carry a float tier that is built and measured</b>;
        its format, its lane counts and its accuracy are KohakuMPE's numbers to
        state, not this core's. That is where a kernel needing float should be,
        not in this EX stage —
        <RouterLink to="/mpe/simd" class="doc-link">SIMD PE</RouterLink>,
    ...
    <SpecTable
      :cols="changeMind.cols"
      :rows="changeMind.rows"
      caption="What would change that answer"
    />
    ...
    <p class="doc-p">
      ...
      of
      <code>RV32M</code>, <code>Zbb</code>, a larger predictor, a larger L1,
      multiple outstanding misses, atomics, DSP or SIMD lanes is a separate
      experiment: add one feature, measure resources and frequency, measure
      workload benefit.
    </p>
    ...
    <SpecTable
      ...
      :rows="[
        {
          s: 'new functional units',
          w: 'the EX stage\'s ALU select, widened; the decoder already routes <code>funct3</code>/<code>funct7</code>',
        },
        {
          s: 'wide operands',
          w: 'a second register file beside <code>rv_regfile</code>, on the same two-boundary read timing',
        },
        {
          s: 'wide memory',
          w: 'the internal L1\'s line is already 256 bits at the fill boundary; only the CPU-side port is 32',
        },
        {
          s: 'bulk peer transfer',
          w: 'a write-combining buffer in front of the requestor\'s push path',
        },
        {
          s: 'more miss concurrency',
          w: 'the requestor\'s single tag becomes a small MSHR table; <code>rv_l1</code>\'s blocking FSM is what changes',
        },
      ]"
