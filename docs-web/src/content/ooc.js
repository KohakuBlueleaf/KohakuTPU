...
const gpuSched = {
  ...
  rows: [
    ...
    },
    {
      ...
      bram: 8,
      ctrlsets: 84,
      settings: "top=kht_core waves=16",
    },
  ],
  fmax: {
    "sc-w1": { noc_clk: 277.9 },
...
const gpuLanes = {
  ...
  top: "kht_unit",
  fixed:
    "WAVES=16, mask=1, ipdom=1, VREG_PRIM=block, HAS_SHFL=0, period=3.333 ns",
  doc: "docs/projects/kohakumpe/simt/ladder.md",
  rows: [
    {
      config: "l-4",
...
const gpuLds = {
  ...
  rows: [
    ...
    },
    {
      ...
      bram: 32,
      ctrlsets: 36,
      settings: "top=kht_lds lanes=32",
    },
  ],
  fmax: {
    "lds-4": { noc_clk: 643.1 },
    "lds-8": { noc_clk: 514.9 },
    "lds-16": { noc_clk: 339.2 },
    "lds-32": { noc_clk: 317.7 },
  },
};
...
const gpuShfl = {
  ...
  rows: [
    ...
    },
    {
      ...
      bram: 32,
      ctrlsets: 36,
      settings: "lanes=32 shfl=1",
    },
  ],
  fmax: {
    "sh-4-off": { noc_clk: 324.1 },
    "sh-4-on": { noc_clk: 302.3 },
    "sh-8-off": { noc_clk: 324.1 },
    "sh-8-on": { noc_clk: 285.5 },
    "sh-16-off": { noc_clk: 324.0 },
    "sh-16-on": { noc_clk: 303.7 },
    "sh-32-off": { noc_clk: 324.1 },
    "sh-32-on": { noc_clk: 301.7 },
  },
};
...
const gpuVregprim = {
  ...
  rows: [
    ...
    },
    {
      ...
      bram: 0,
      ctrlsets: 165,
      settings: "VREG_PRIM=distributed",
    },
  ],
...
const gpuPe = {
  ...
  varies:
    "LANES and WAVES on kht_pe — the whole unit with L1, requestor and port",
  top: "kht_pe",
  fixed:
    "HAS_SHFL=1 (G8 IN), mask=1, ipdom=1, VREG_PRIM=block, period=3.333 ns",
  ...
  rows: [
    {
      ...
      ctrlsets: 162,
      settings:
        "top=kht_pe lanes=8 waves=16 mask=1 ipdom=1 shfl=1 period=3.333",
    },
    {
      config: "pe-l8-w1",
      lut: 14709,
    ...
    },
    {
      ...
      ctrlsets: 154,
      settings:
        "top=kht_pe lanes=4 waves=16 mask=1 ipdom=1 shfl=1 period=3.333",
    },
    {
      config: "pe-l16-w16",
      lut: 29961,
      ...
      ctrlsets: 178,
      settings:
        "top=kht_pe lanes=16 waves=16 mask=1 ipdom=1 shfl=1 period=3.333",
    },
  ],
  fmax: {
...
const stationWidth = {
  ...
  rows: [
    ...
    },
    {
      ...
      bram: 0,
      ctrlsets: 541,
      settings: "fw=512 aw=43",
    },
    {
      config: "w-fw1024-aw43",
      lut: 22641,
      lut_log: 11903,
      lut_mem: 10738,
      lut_dram: 10738,
...
const stationPorts = {
  ...
  fixed:
    "3 × 512-bit managers, Q × 512-bit subordinates, FW=512, AW=43, ost=4, sfwd=1, no block RAM",
  doc: "docs/projects/kohakuaxi/station-bus.md",
...
const linePorts = {
  ...
  top: "sb_line4",
  fixed:
    "FW=512, AW=43, BALANCED, no block RAM, LINK_CDC=1, LINK_FULL=0, period=5.000 ns",
  doc: "docs/projects/kohakuaxi/station-bus.md",
...
const lineWidth = {
  ...
  top: "sb_line4",
  fixed:
    "NQ=4, NM=3, BALANCED, no block RAM, LINK_CDC=1, LINK_FULL=0, period=5.000 ns",
  doc: "docs/projects/kohakuaxi/station-bus.md",
  ...
  rows: [
    ...
    },
    {
      ...
      bram: 0,
      ctrlsets: 977,
      settings: "fw=256 aw=32",
    },
    {
      config: "lw-fw256-aw64",
      lut: 24255,
      lut_log: 15865,
      lut_mem: 8390,
      lut_dram: 8390,
      ...
      bram: 0,
      ctrlsets: 977,
      settings: "fw=256 aw=64",
    },
    {
      config: "lw-fw512-aw32",
      lut: 30339,
      lut_log: 19931,
      lut_mem: 10408,
      lut_dram: 10408,
...
const xbarAnchor = {
  ...
  fixed:
    "3 slave interfaces throughout; strat 2 = max-performance, 1 = minimum-area (SASD)",
  doc: "docs/projects/kohakuaxi/station-bus.md",
  scope:
    "whole harness, NOT the instance — station-bus.md §2.6's tables are instance figures and are 1.2–2.1k lower.",
  rows: [
    {
      config: "xbar-3x9-perf",
      lut: 18627,
      lut_log: 15727,
      lut_mem: 2900,
      lut_dram: 2848,
      ...
      bram: 37.5,
      ctrlsets: 1037,
      settings: "nsi=3 nmi=9 dw=512 nclk=4 strat=2",
    },
    {
      config: "xbar-3x9-area",
      lut: 12068,
      lut_log: 9498,
      lut_mem: 2570,
      lut_dram: 2560,
      ...
      bram: 6,
      ctrlsets: 724,
      settings: "nsi=3 nmi=9 dw=512 nclk=4 strat=1",
    },
    {
      config: "xbar-3x9-1clk-perf",
      lut: 7934,
      lut_log: 7449,
      lut_mem: 485,
      lut_dram: 448,
      ...
      bram: 1.5,
      ctrlsets: 570,
      settings: "nsi=3 nmi=9 dw=512 nclk=1 strat=2",
    },
    {
      config: "xbar-3x9-1clk-area",
      lut: 5674,
      lut_log: 5225,
      lut_mem: 449,
      lut_dram: 448,
      ...
      bram: 0,
      ctrlsets: 343,
      settings: "nsi=3 nmi=9 dw=512 nclk=1 strat=1",
    },
    {
      config: "xbar-3x5-perf",
      lut: 10297,
      lut_log: 8836,
      lut_mem: 1461,
      lut_dram: 1424,
      ...
      bram: 31.5,
      ctrlsets: 648,
      settings: "nsi=3 nmi=5 dw=512 nclk=4 strat=2",
    },
    {
      config: "xbar-3x5-area",
      lut: 7656,
      lut_log: 5601,
      lut_mem: 2055,
      lut_dram: 2048,
      ...
      bram: 3,
      ctrlsets: 439,
      settings: "nsi=3 nmi=5 dw=512 nclk=4 strat=1",
    },
    {
      config: "xbar-3x9-256-perf",
      lut: 14898,
      lut_log: 13068,
      lut_mem: 1830,
      lut_dram: 1776,
      ...
      bram: 25.5,
      ctrlsets: 1035,
      settings: "nsi=3 nmi=9 dw=256 nclk=4 strat=2",
    },
    {
      config: "xbar-3x9-256-area",
      lut: 10851,
      lut_log: 8857,
      lut_mem: 1994,
      lut_dram: 1984,
      ...
      bram: 6,
      ctrlsets: 764,
      settings: "nsi=3 nmi=9 dw=256 nclk=4 strat=1",
    },
  ],
...
const smcBase = {
  ...
  doc: "docs/projects/kohakuaxi/station-bus.md",
  scope:
    "whole harness, NOT the instance. The lut_dram column IS the instance's — 4,522 at 3x9 in both clock counts.",
  rows: [
    {
      config: "smc-3x9-4clk",
      lut: 23178,
      ...
      bram: 9,
      ctrlsets: 1619,
      settings: "nsi=3 nmi=9 dw=512 nclk=4",
    },
    {
      config: "smc-3x9-1clk",
      lut: 22653,
      ...
      bram: 9,
      ctrlsets: 1624,
      settings: "nsi=3 nmi=9 dw=512 nclk=1",
    },
    {
      config: "smc-3x5-4clk",
      lut: 15183,
      ...
      bram: 5,
      ctrlsets: 1104,
      settings: "nsi=3 nmi=5 dw=512 nclk=4",
    },
    {
      config: "smc-1x5-2clk",
      lut: 6714,
      ...
      bram: 5,
      ctrlsets: 614,
      settings: "nsi=1 nmi=5 dw=512 nclk=2",
    },
...
export const DERIVED = {
  simtGates: {
    ...
    detail:
      "g3-ipdom 3,204 − g0-substrate 2,952, on a 2,952 substrate at 8 lanes.",
  },
  wavesAreFree: {
    from: "gpu-ladder",
    claim:
      "Sixteen resident wave contexts cost +0 LUT, +0 BRAM, +0 control sets and +4 FF",
    detail:
      "g1-waves against g0-substrate. Storage only — mask and IPDOM are off on both rows.",
  },
  wavesCostToSchedule: {
    from: ["gpu-waves", "gpu-sched"],
    claim: "+1,775 LUT to schedule sixteen waves, +124 LUT to store them",
    detail:
      "kht_core 9,653 − 7,754 = +1,899; kht_unit 3,200 − 3,076 = +124; the difference is the front end.",
  },
  laneFit: {
    from: "gpu-lanes",
    claim: "LUT = 112 + 386.4 × LANES, FF = 116 + 50 × LANES, BRAM = 1 × LANES",
    detail:
      "Exact at 4, 8 and 32; +61 LUT at 16. The FF fit is exact at all four points.",
  },
  ldsQuadratic: {
    from: "gpu-lds",
    claim:
      "LUT ≈ 25 × LANES², and at 32 lanes the LDS is BELOW the rest of the unit's clock",
    detail:
      "317.7 MHz against 324.1. Flops and BRAM stay linear; only the LANES × LANES resolver squares.",
  },
  shflNLogN: {
    from: "gpu-shfl",
  ...
  stationPortSlope512: {
    from: "station-ports",
    claim:
      "1,621 LUT, 4,031 FF and exactly 42 control sets per 512-bit subordinate port",
    detail:
  ...
  linePortSlope32: {
    ...
    detail:
      "Endpoints q-1 and q-8, 28 ports apart; interior points deviate 3.1%, 0.2% and 1.3%.",
  },
  areaFlatToTarget: {
    from: "line-freq",
    claim:
      "Area is flat to a 300 MHz ask (0.3%), then rises 6.3% at 350 and 11% beyond",
    detail:
  ...
  clockDomainCost: {
    ...
    claim:
      "1 → 4 clock domains at 3x9: axi_interconnect +10,693 / +6,394, SmartConnect +525",
    detail:
  ...
  widthSensitivity: {
    ...
    claim:
      "512 → 256 returns 28.2% on the line, 20.0% on max-perf axi_interconnect, 10.1% on SASD",
    detail:
      "The more of a structure is datapath, the more halving the width returns.",
  },
  assembledPeIsInBudget: {
    from: "gpu-pe",
    claim:
      "The assembled SIMT PE at 8 lanes is 16,115 LUT — inside the 20–25k band, integer-only",
    detail:
  ...
  assembledPeMissesTheClock: {
    ...
    claim:
      "The assembled PE runs at 170–190 MHz where every submodule row sat at 324.1",
    detail:
...
export const KNOWN_DISAGREEMENTS = [
  {
    ...
    values:
      "3,204 LUT in gpu-ladder, gpu-lanes and gpu-shfl; 3,200 in gpu-waves",
    detail:
  ...
  },
  {
    ...
    values:
      "The sweep files record the whole harness; station-bus.md §2.6 records the instance",
    detail:
