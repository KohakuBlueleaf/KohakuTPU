# tclsh scripts/tcl/v8/check_map.tcl -- the intended address map, printed from
...
# The permutation, applied to a page address: page p of size 2^ILV_LG lands
# on home p % 4, and the channel's own address is p / 4 pages -- printed for
# the first sixteen pages so the OS's expectation is on the record.
proc v8_perm {addr} {
...
# The top of the flat space must still be inside 4 GB per channel.
