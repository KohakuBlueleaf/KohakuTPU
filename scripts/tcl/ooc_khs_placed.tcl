# The KohakuSIMD vector unit, SYNTHESISED AND PLACED.
#   vivado -mode batch -source scripts/tcl/ooc_khs_placed.tcl -tclargs \
...
puts "@@@ top khs_unit PLACED simd $simd muls $muls shift $hsh perm $hpm wb $wbs period $per"
