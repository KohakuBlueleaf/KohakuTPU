# v8t2 post-route report: per-SLR and per-pblock resources, the big cells per
...
# Run from v8t2_impl.tcl or alone:
#   vivado -mode batch -source scripts/tcl/v8t2/80_report.tcl
if {![info exists design_name]} {
    set here [file dirname [file normalize [info script]]]
    source $here/00_config.tcl
    open_project $proj_dir/${design_name}.xpr
}
open_run impl_1 -name v8t2_impl
set out $root/build
file mkdir $out
