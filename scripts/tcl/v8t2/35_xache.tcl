...
proc v8_bytes {vals} {
    if {[llength $vals] > 32} { error "v8t2 xache: [llength $vals] swap pairs, the wrapper holds 32" }
...
puts "@@@ v8t2 xache: kx_pxache 4x4, P 4, K $KX_K, SETS $KX_SETS, BANKS $KX_BANKS, NSWAP $KX_NSWAP,\
