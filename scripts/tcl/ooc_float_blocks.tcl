...
#   vivado -mode batch -source scripts/tcl/ooc_float_blocks.tcl -tclargs <period_ns>
#
# The lane measures 609 LUT (ooc_khs.tcl, s8-float) and a flat total cannot say
...
foreach top {khs_blk_align khs_blk_align_dsp khs_blk_norm khs_blk_norm_dsp \
             ...
             khs_blk_cvt_in khs_blk_cvt_out} {
    puts "@@@ ============================ $top"
    read_verilog $srcs
