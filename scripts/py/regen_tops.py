...
MANIFEST = [
    ...
    # multimesh_v8: staging kept, NO CU/vector L2 adapters (the Xache is the L3),
    # per-domain reset entry. 6+2 on the die under test, 2+2 on the other three.
    (
        "ktpu_ship_2x2_6c2v_1m_nol2",
        "mesh_2x2_6+2.txt",
        True,
        True,
        (True, False, False),
